...
parser = argparse.ArgumentParser(
    description="Tools for sampling images from the testing split of a dataset and "
...
parser.add_argument(
    "--test_json",
    type=str,
    help="Path to test.json generated by the make_classification_dataset.py script",
)
# Optional parameters
parser.add_argument(
    "--output_dir",
...
parser.add_argument(
    "--num_samples",
    type=int,
    help="Number of samples to selected. Default: 5",
    default=10,
)
    ...
    with tf.Session() as sess:
        ...
        for image_path in selected_images:
            ...
            out_image = os.path.join(
                args.output_dir,
                "___".join(os.path.normpath(image_path).split(os.path.sep)),
            )
