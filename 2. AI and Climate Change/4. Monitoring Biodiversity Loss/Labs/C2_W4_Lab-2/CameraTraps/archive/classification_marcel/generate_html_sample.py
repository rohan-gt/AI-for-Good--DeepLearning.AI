...
parser = argparse.ArgumentParser(
    description="Tools for sampling images, applying a classifier, and generating a html "
    + "summary for it."
)
...
parser.add_argument(
    ...
    + "it with the scripts in this directory",
    metavar="PATH_TO_CLASSIFIER_W_PREPROCESSING",
)
parser.add_argument(
    "--class_list",
    type=str,
    help="Simple plain text file containing the list of classes corresponding to the model.",
)

parser.add_argument(
    "--image_list",
    type=str,
    help="Simple plain text file containing a list of image paths.",
)
...
parser.add_argument(
    "--image_dir",
    type=str,
    help="Root directory of the images in the image list.",
    default=None,
)
parser.add_argument(
    "--output_dir",
    type=str,
    help="Path to output directory. We will copy sample images to this location "
    + ' and also save the output as text file here. Default: "./sample_output"',
    default="./sample_output",
)
parser.add_argument(
    "--num_samples",
    type=int,
    help="Number of samples to selected. Default: 3000",
    default=3000,
)
parser.add_argument(
    "--binary_threshold",
...
with model_graph.as_default():
    with tf.Session(config=tf.ConfigProto()) as sess:
        ...
        for image_path in tqdm.tqdm(selected_images):
            ...
            display_name = (
                "<b>Class</b>: {}, <b>{}</b>: {:.4%}, <b>Image</b>: {}".format(
            ...
            cur_image_html = render_bounding_boxes(
                args.image_dir,
                out_image_name,
                display_name,
                [],
