...
ax.legend(
    ...
    ("w/deer, w/o iNat", "w/ deer, w/ iNat", "w/o deer, w/o iNat", "w/o deer, w/iNat"),
    loc="lower center",
)
...
plt.savefig(
    "/ai4efs/models/object_detection/faster_rcnn_inception_resnet_v2_atrous/train_on_ss_no_deer_and_inat/predictions/compare_per_seq_mAP_w_deer_and_no_deer.jpg"
)
