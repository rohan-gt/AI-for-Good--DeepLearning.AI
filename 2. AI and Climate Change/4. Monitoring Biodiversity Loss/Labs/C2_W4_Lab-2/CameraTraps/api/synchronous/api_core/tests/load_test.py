...
def call_api(args):
    ...
    print(
        "\napi {} status code: {}, elapsed time in seconds {}".format(
            index, response.status_code, elapsed_time.total_seconds()
        )
    )
...
if __name__ == "__main__":
    params = {"min_confidence": 0.15, "min_rendering_confidence": 0.8, "render": True}
