...
def combine_api_output_dictionaries(
    input_dicts: Iterable[Mapping[str, Any]], require_uniqueness: bool = True
) -> Dict[str, Any]:
    ...
    if n_redundant_images > 0:
        print(
            f"Warning: found {n_redundant_images} redundant images "
