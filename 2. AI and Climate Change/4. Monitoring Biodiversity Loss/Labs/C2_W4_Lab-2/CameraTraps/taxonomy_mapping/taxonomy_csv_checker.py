...
def check_taxonomy_csv(csv_path: str) -> None:
        ...
        for j, taxon in enumerate(taxa_ancestry):
            ...
            if j == 0:
                ...
                if scientific_name != taxon_name:
                    print(f"row: {i}, {ds}, {ds_label}")
                    print(
                        f"- scientific_name column: {scientific_name}, "
    ...
    try:
        ...
        print("All ambiguous parents have hard-coded resolution in dag_to_tree().")
...
if __name__ == "__main__":
    ...
    parser.add_argument("taxonomy_csv_path", help="path to taxonomy CSV file")
