...
def enumerate_folders():
    ...
    #
    folders, _ = walk_container(container_client, max_depth=depth, store_blobs=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--container_name", help="Blob container name")
    parser.add_argument(
        "--ro_sas_token",
    ...
    if args.sas_url is not None:
        assert (
            args.account_name is None
            and args.container_name is None
            and args.ro_sas_token is None
        )
        ...
        assert (
            args.account_name is not None
            and args.container_name is not None
            and args.ro_sas_token is not None
        )
