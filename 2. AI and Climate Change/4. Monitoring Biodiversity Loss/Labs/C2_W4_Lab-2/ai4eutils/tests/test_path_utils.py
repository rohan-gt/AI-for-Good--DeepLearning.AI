...
from path_utils import fileparts, insert_before_extension, split_path, top_level_folder
...
class Tests(unittest.TestCase):
    ...
    def test_insert_before_extension(self, mock_dt):
        ...
        r = insert_before_extension(filename="/dir/subdir/file.jpg", s="newstring")
        self.assertEqual(r, "/dir/subdir/file.newstring.jpg")

        # Windows path with extension
        r = insert_before_extension(filename=r"c:\dir\file.jpg", s="newstring")
        self.assertEqual(r, r"c:\dir\file.newstring.jpg")

        # Unix path without extension
        r = insert_before_extension(filename="/dir/subdir/file", s="newstring")
        self.assertEqual(r, "/dir/subdir/file.newstring")

        # Windows path without extension
        r = insert_before_extension(filename=r"c:\dir\file", s="newstring")
