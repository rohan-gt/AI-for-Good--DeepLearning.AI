...
if __name__ == "__main__":
    ...
    with tempfile.TemporaryDirectory() as base_dir:
        ...
        assert (
            "https://naipblobs.blob.core.windows.net/naip/v002/wa/2011/wa_100cm_2011/47122/m_4712223_se_10_1_20110826.tif"
            in tiles
        )
        ...
        lat, lon = (
            -122.139152,
            47.644184,
        )  # Swapped lat, lon points from the previous example
        try:
        ...
        }  # a rectangle on the Delmarva peninsula
        tiles = naip_index.lookup_geom(geom)
        assert (
            "https://naipblobs.blob.core.windows.net/naip/v002/de/2011/de_100cm_2011/38075/m_3807537_ne_18_1_20110602.tif"
            in tiles
        )
