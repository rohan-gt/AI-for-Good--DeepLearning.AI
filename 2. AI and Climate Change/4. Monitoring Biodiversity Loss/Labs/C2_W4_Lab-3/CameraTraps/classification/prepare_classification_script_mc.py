...
input_filename = (
    "idfg-2022-01-27-EOE2021S_Group6_detections.filtered_rde_0.60_0.85_30_0.20.json"
)
image_base = "/datadrive/idfg/EOE2021S_Group6"
crop_path = os.path.join(os.path.expanduser("~/crops"), job_name + "_crops")
device_id = 0

working_dir_base = os.path.join(
    os.path.expanduser("~/postprocessing"), organization_name, job_name
)
