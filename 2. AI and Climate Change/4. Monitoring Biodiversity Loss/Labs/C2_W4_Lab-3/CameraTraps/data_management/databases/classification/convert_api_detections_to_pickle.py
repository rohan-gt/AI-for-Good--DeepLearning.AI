...
parser = argparse.ArgumentParser(
    "This file converts the CSV output of the batch processing API to a pickle file, "
    + "which can be used by the script ./make_classification_dataset.py"
)
parser.add_argument(
    "input_csv", type=str, help="Path to the CSV file that contains the API output"
)
parser.add_argument(
