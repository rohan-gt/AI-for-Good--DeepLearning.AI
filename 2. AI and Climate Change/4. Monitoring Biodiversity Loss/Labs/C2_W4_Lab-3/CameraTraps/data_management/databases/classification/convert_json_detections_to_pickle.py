...
parser = argparse.ArgumentParser(
    "This file converts the JSON output of the batch processing API to a pickle file, "
    + "which can be used by the script ./make_classification_dataset.py"
)
parser.add_argument(
    "input_json", type=str, help="Path to the JSON file that contains the API output"
)
parser.add_argument(
    "output_pkl", type=str, help="Path to the desired output pickle file"
)
parser.add_argument(
    "--detection_category_whitelist",
    nargs="+",
    default=["1"],
    metavar="CAT_ID",
