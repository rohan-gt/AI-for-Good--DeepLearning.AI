...
def convertJsonToStringList(
    inputFilename,
    outputFilename=None,
    prepend="",
    bConfirmExists=False,
    bForceForwardSlash=True,
    imageBase="",
):
    assert os.path.isfile(inputFilename), ".json file {} does not exist".format(
        inputFilename
    )
...
if False:
    ...
    convertJsonToStringList(
        ...
        prepend=prepend,
        bConfirmExists=True,
        imageBase=r"D:\wildlife_data\awc",
    )
