...
output_json_filename = os.path.join(
    input_base, organization_name + "_camera_traps.json"
)
...
ordered_json_filename = os.path.join(
    input_base, organization_name + "_camera_traps_ordered.json"
)
ordered_preview_base = os.path.expanduser(
    "~/data/" + organization_name + "/preview-ordered"
)
...
print("Loaded {} ground truth annotations".format(len(images_df)))
