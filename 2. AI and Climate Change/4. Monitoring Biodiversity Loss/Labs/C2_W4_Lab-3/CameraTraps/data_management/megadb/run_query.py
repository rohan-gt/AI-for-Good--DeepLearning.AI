...
result_iterable = db_utils.query_sequences_table(
    query=query, partition_key=partition_key, parameters=query_parameters
)
...
if consolidate_results:
    ...
    print(
        f"Number of items from iterable is {item_count}; "
