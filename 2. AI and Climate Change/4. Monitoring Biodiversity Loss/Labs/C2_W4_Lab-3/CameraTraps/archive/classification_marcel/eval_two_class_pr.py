...
parser = argparse.ArgumentParser(
    "This script evaluates the precision/recall of an exported frozen inference graph on the test data of "
    ...
    with tf.Session() as sess:
        ...
        for image_id in tqdm.tqdm(all_img_keys):
            ...
            image_path = os.path.join(
                args.coco_style_output, coco.imgs[image_id]["file_name"]
            )
            ...
            predictions = [
                0
            ]  # sess.run(predictions_tensor, feed_dict={image_tensor: image})
            ...
            if total % 100 == 0:
                print(
                    "Currently at {:.2f}% top-1 accuracy".format(correct / total * 100)
                )
...
print(
    "Best precision >= 0.99 recall: recall {}, prec {}, at threshold {}".format(
