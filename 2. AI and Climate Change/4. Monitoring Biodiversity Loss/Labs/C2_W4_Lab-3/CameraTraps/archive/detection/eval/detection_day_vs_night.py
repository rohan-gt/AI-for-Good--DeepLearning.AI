...
if __name__ == "__main__":
    ...
    day_prec, day_recall, day_ap = compute_precision_recall(
        detection_file,
        detection_results=detection_results,
        images_to_consider="day",
        get_night_day=day_night_json,
    )
    night_prec, night_recall, night_ap = compute_precision_recall(
        detection_file,
        detection_results=detection_results,
        images_to_consider="night",
        get_night_day=day_night_json,
    )
    ...
    print(
        "Night prec. at ", night_recall[recall_idx], " recall: ", night_prec[recall_idx]
    )
    ...
    np.savez(
        det_folder + exp_name + "_day_v_night_prec_recall_data.npz",
        day_prec=day_prec,
        day_recall=day_recall,
        day_ap=day_ap,
        night_prec=night_prec,
