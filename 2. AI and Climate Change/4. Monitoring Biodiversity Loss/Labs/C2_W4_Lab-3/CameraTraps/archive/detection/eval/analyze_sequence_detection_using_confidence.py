...
if __name__ == "__main__":
    inter_prec, inter_recall, inter_ap, _ = compute_precision_recall_with_sequences(
        det_folder + "cis_test.p", db_file
    )
    loc_prec, loc_recall, loc_ap, _ = compute_precision_recall_with_sequences(
    ...
    np.savez(
        det_folder + "seq_cis_v_trans_prec_recall_data_with_conf_thresh.npz",
        cis_prec=inter_prec,
