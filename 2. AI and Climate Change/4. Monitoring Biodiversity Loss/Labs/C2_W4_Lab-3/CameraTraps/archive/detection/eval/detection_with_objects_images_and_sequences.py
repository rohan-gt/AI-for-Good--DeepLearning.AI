...
from analyze_image_detection_one_guess_per_image import (
    compute_precision_recall_with_images,
)
from analyze_sequence_detection_one_guess_per_sequence import (
...
if __name__ == "__main__":
    ...
    seq_prec, seq_recall, seq_ap = compute_precision_recall_with_sequences(
    ...
    np.savez(
        det_folder + exp_name + "_obj_im_seq_prec_recall_data.npz",
        prec=prec,
        recall=recall,
        ap=ap,
        im_prec=im_prec,
