...
database_file = (
    "/home/yasiyu/yasiyu_temp/eMammal_db/eMammal_20180929_nohuman_tfrecord_format.json"
)
...
if split_by == "location":  # make train, val and test in terms of image IDs
    ...
    print(
        "Including empties, there are {} train imgs, {} val imgs, {} test imgs.".format(
            num_train, num_val, num_test
        )
    )

    print(
        "Number of empty images: {} in train, {} in val, {} in test.".format(
            num_empty_train, num_empty_val, num_empty_test
        )
    )

    print(
        "Actual number of images included in tfrecords: {} in train, {} in val, {} in test".format(
