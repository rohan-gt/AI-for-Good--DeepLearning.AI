...
def is_image_file(s: str, img_extensions: Container[str] = IMG_EXTENSIONS) -> bool:
...
def clean_filename(
    filename: str, whitelist: str = VALID_FILENAME_CHARS, char_limit: int = CHAR_LIMIT
) -> str:
    r"""
...
def clean_path(
    pathname: str, whitelist: str = VALID_PATH_CHARS, char_limit: int = CHAR_LIMIT
) -> str:
    """
