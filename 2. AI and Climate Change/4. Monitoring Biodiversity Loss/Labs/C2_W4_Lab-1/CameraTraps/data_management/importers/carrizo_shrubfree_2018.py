...
input_metadata["file"] = input_metadata[["file", "rep"]].apply(
    lambda x: "{0}\IMG_{1}.JPG".format(x[1], str(x[0]).zfill(4)), axis=1
)
...
html_output_file, image_db = visualize_db.process_images(
    ...
    output_dir=os.path.join(output_base, "carrizo shrub-free 2018/preview"),
