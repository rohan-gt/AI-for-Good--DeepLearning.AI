...
mapped_fields = {
    "No. of Animals in Photo": "num_animals",
...
for i_row, fn in tqdm(
    enumerate(input_metadata["Image Name"]), total=len(input_metadata)
):
    # Ignore directories
...
print(
    "Finished verifying image existence for {} files in {}, found {} filenames with multiple labels, {} missing images".format(
...
print(
    "Finished checking {} images to make sure they're in the metadata, found {} unannotated images".format(
    ...
    for i_row in row_indices:
        ...
        if img_id in image_ids_to_images:
            ...
            if im["datetime"] != timestamp:
                print(
                    "Warning: timestamp conflict for image {}: {},{}".format(
