...
input_metadata["file"] = input_metadata["file"].apply(
    lambda x: x.replace(".jpg", ".JPG")
)
...
print(
    "Finished verifying image existence in {}, found {} filenames with multiple labels".format(
