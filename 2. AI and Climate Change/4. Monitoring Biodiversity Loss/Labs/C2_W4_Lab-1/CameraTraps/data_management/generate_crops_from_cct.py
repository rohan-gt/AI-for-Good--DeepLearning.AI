...
def generate_crops_from_cct(
    cct_file, image_dir, output_dir, padding=0, flat_output=True
):
    ...
    print(
        "Found {} boxes in {} annotations for {} images".format(
    ...
    for im in tqdm(d["images"]):
        ...
        assert os.path.isfile(input_image_fn), "Could not find image {}".format(
            input_image_fn
        )
