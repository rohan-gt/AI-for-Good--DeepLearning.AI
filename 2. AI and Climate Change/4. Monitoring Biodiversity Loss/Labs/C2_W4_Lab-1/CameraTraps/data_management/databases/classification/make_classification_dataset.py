...
sys.path.append(
    os.path.join(os.path.dirname(os.path.realpath(__file__)), "../../tfrecords/utils")
)
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            "Frozen graph of detection network as created by "
    ...
    parser.add_argument(
        ...
        metavar="location",
        help=(
            "Key in the image-level annotations that specifies the splitting "
    ...
    parser.add_argument(
        ...
        default=[],
        help=(
            "Categories to ignore during detection. We also will not use "
    ...
    parser.add_argument(
        ...
        type=str,  # default = None
        help=(
            "Path to a pickle file of existing detections generated by this "
    ...
    parser.add_argument(
        ...
        default=1.3 * 1.3,
        help=(
            "We crop a tight square box around the animal enlarged by this "
...
def validate_args(args: argparse.Namespace) -> str:
    ...
    if args.coco_style_output is None and args.tfrecords_output is None:
        raise ValueError(
            "Please specify at least one of --coco_style_output or --tfrecords_output"
        )
    if args.coco_style_output is not None:
        detection_output = os.path.join(args.coco_style_output, "detections_final.pkl")
    else:
        detection_output = os.path.join(args.tfrecords_output, "detections_final.pkl")
...
def main(
    ...
    cat_id_to_new_id = {
        old_key: idx for idx, old_key in enumerate(cat_id_to_names.keys())
    }
    ...
    print(
        "{} locations in total, {} for training, {} for testing".format(
