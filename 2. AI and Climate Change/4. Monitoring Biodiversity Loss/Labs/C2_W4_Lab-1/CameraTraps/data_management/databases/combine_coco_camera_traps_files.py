...
def combine_cct_dictionaries(
    input_dicts: Iterable[Mapping[str, Any]], require_uniqueness: Optional[bool] = True
) -> Dict[str, Any]:
    ...
    all_categories = [
        {"id": category_name_to_id[cat_name], "name": cat_name}
        for cat_name in category_name_to_id.keys()
    ]
