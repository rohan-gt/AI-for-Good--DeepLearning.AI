...
def main():
    ...
    parser.add_argument(
        "--debugMaxRenderDetection", action="store", type=int, default=-1
    )
    parser.add_argument(
        "--debugMaxRenderInstance", action="store", type=int, default=-1
    )

    parser.add_argument(
        "--forceSerialComparisons", action="store_false", dest="bParallelizeComparisons"
    )
    parser.add_argument(
        "--forceSerialRendering", action="store_false", dest="bParallelizeRendering"
    )
    ...
    repeat_detections_core.find_repeat_detections(
        args.inputFile, args.outputFile, options
    )
