...
frame_filenames_by_video, fs_by_video = video_utils.video_folder_to_frames(
...
print(
    "Found {} folders for {} files".format(len(folder_to_frame_files), len(frame_files))
)
...
print(
    "{} of {} folders are missing frames entirely".format(
        len(missing_videos), len(video_filenames)
    )
)
...
print(
    "{} of {} folders have fewer than {} frames".format(
