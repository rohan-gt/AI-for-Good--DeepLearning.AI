...
def get_base_AL_mapping():
    ...
    from active_learning_methods.informative_diverse import (
    ...
    from active_learning_methods.represent_cluster_centers import (
...
def get_wrapper_AL_mapping():
    ...
    AL_MAPPING["bandit_mixture"] = partial(
        ...
        samplers=[
            {"methods": ["margin", "uniform"], "weights": [0, 1]},
            {"methods": ["margin", "uniform"], "weights": [0.25, 0.75]},
            {"methods": ["margin", "uniform"], "weights": [0.5, 0.5]},
            {"methods": ["margin", "uniform"], "weights": [0.75, 0.25]},
    ...
    AL_MAPPING["simulate_batch_best_sim"] = partial(
        SimulateBatchSampler,
        samplers=[{"methods": ["margin", "uniform"], "weights": [1, 0]}],
        n_sims=10,
        train_per_sim=10,
