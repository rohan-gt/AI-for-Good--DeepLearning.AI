...
def main():
    ...
    parser.add_argument(
        "--output_dir", type=str, help="Output directory for subset of crops"
    )
    ...
    with open(
        os.path.join(args.output_dir, "lastlayer_features_and_labels.mat"), "wb"
    ) as f:
        scipy.io.savemat(
            f, mdict={"features": sample_features, "labels": sample_labels}
        )
